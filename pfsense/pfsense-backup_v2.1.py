...
"""
Backup old PFsense 2.1 Release skipping the following ssl errors:
    urllib2.URLError: <urlopen error [SSL: DH_KEY_TOO_SMALL] dh key too small
    urllib2.URLError: <urlopen error [SSL: CERTIFICATE_VERIFY_FAILED] certificate verify failed

Usage:
    pfsense-backup_v2.1.py -s https://server.domain/ -u user1 -p passwd1 -d /tmp/ -f mybackup.txt
